...
//   say     a plain-English "sounds like", stressed SYLLABLE in capitals. This
//           is the part you actually memorise - the synthesised voice is a
//           second opinion, not the authority
...
//   lang    which voice reads it aloud. The French wines are unlistenable in an
//           English voice - "Chateau Pey La Tour" comes out as "chatoo pey la
//           tower" - so those are handed to a French voice where the phone has
//           one, using the `speak` text rather than the full menu line
//
// Items with no `say` are ordinary English that needs no guide (Screwdriver,
// Bloody Mary, Still, Apple). The app leaves the line out for those.
...
var MENU = [

  {
    id: 'food',
    name: 'Food',
    sub: 'Lunch · International Menu',
    taste: 'Satay · Biryani · Chendol',
    sections: [

      { name: 'Canapé', say: 'KAN-uh-pay', items: [
        {
      ...
      { name: 'Dessert', items: [
        {
          ...
          say: 'LYE-chee · pistachio = pis-TASH-ee-oh',
        ...
        },
        {
          ...
          say: 'ar-tih-ZAN-ul · St Paulin = san poh-LAN',
...

  {
    ...
    taste: 'Heidsieck · Cairanne · Kopke',
    sections: [
...

  {
    ...
    taste: 'Singapore Sling · Bellini · Campari',
    sections: [
...

  {
    ...
    taste: 'Courvoisier · Ardbeg · Cointreau',
    sections: [
...

  {
    ...
    taste: 'Midsummer Breeze · Apple Bliss',
    sections: [
...
// The small print that sits under a section on the real menu. Worth knowing by
// heart - it is the line you fall back on when a passenger asks for something
// that is not on board.
var MENU_NOTES = {
  wine: 'Please check which of the above wines is available on this flight',
  cocktails: 'Please accept our apologies if your choice is unavailable',
  spirits: 'Please accept our apologies if your choice is unavailable'
};
